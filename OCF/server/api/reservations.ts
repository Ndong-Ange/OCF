import { reservationService, Reservation } from '../lib/database';

// API Routes pour les réservations
export const reservationAPI = {
  // POST /api/reservations - Créer une réservation
  create: async (reservationData: Omit<Reservation, 'id' | 'created_at'>) => {
    try {
  ...
  // GET /api/reservations/:date - Réservations par date
  getByDate: async (date: string) => {
    try {
      ...
      console.error('Erreur API - Réservations par date:', error);
